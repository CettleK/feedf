  ...
  return (
    ...
    <div className="bg-gray-900 rounded-xl shadow-md p-6">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {trackerData ? (
          <>
            <div className="bg-gray-700 p-6 rounded-lg shadow hover:shadow-lg transition-shadow duration-300">
              <h3 className="font-semibold text-lg text-white">
                Blood Pressure
              </h3>
              <p className="text-gray-400">{trackerData.blood_pressure}</p>
            </div>
            <div className="bg-gray-700 p-6 rounded-lg shadow hover:shadow-lg transition-shadow duration-300">
              <h3 className="font-semibold text-lg text-white">
                Heart Rate
              </h3>
              <p className="text-gray-400">{trackerData.heart_rate}</p>
            </div>
            <div className="bg-gray-700 p-6 rounded-lg shadow hover:shadow-lg transition-shadow duration-300">
              <h3 className="font-semibold text-lg text-white">
                Blood Sugar
              </h3>
              <p className="text-gray-400">{trackerData.blood_sugar}</p>
            </div>
            <div className="bg-gray-700 p-6 rounded-lg shadow hover:shadow-lg transition-shadow duration-300">
              <h3 className="font-semibold text-lg text-white">Daily Steps</h3>
              <p className="text-gray-400">{trackerData.daily_steps}</p>
            </div>
            <div className="bg-gray-700 p-6 rounded-lg shadow hover:shadow-lg transition-shadow duration-300">
              <h3 className="font-semibold text-lg text-white">
                Water Intake
              </h3>
              <p className="text-gray-400">{trackerData.water_intake}</p>
            </div>
          </>
        ) : (
          <p className="text-gray-400">Loading tracker stats...</p>
        )}
      </div>
    </div>
     {/* Health Tips Section */}
